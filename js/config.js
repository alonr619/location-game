...
const GAME_CONFIG = {
  ...
  bounds: {
    north: 37.7749 + 0.0001,  // San Francisco latitude + small offset
    south: 37.7749 - 0.0001,
    east: -122.4194 + 0.0001, // San Francisco longitude + small offset
    west: -122.4194 - 0.0001
  }
};
